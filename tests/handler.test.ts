...
describe("Slippage Handler", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it("handles valid query with all required fields", async () => {
    // Mock RPC for pool reserves
    ...
    const result = await handleSlippageQuery({
      ...
      token_out: "0xA0b86a33E6441d84b5F5c76a3b1D8086940e5d4A", // USDC
      amount_in: "10000000000000000000", // 10 ETH
      pool_address: "0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc", // WETH/USDC pool
      chain: "ethereum",
    });
